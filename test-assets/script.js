...
//category tag
let r_score = document.querySelector(".r_score");
let i_score = document.querySelector(".i_score");
let a_score = document.querySelector(".a_score");
let s_score = document.querySelector(".s_score");
let e_score = document.querySelector(".e_score");
...
function showQuestions(index) {
    ...
    let option_tag = '<div class="option"><span>' + questions[index].options[0] + '</span></div>' +
        ...
        '<div class="option"><span>Somewhat Agree</span></div>' +
        '<div class="option"><span>Disagree</span></div>' +
        '<div class="option"><span>Strongly Disagree</span></div>';
