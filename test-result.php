                ...
                <div class="bg-white rounded shadow-sm"><img src="<?php echo $row["c_image"]; ?>" alt="<?php echo $row["c_name"]; ?>" class="img-fluid card-img-top gallery-image">
                  <div class="p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                      <p></p>
                      <button type="button" class="btn btn-primary px-3  text-white" data-toggle="modal" data-target="#modal<?php echo $row['c_id'] ?>">Overview</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
              ...
              <div class="container">
                <div class="border-bottom p-3">
                  ...
                  <small>on: <?php echo date("M d,Y h:i", strtotime($row['f_date'])) ?></small>
                  <small class="a-link edit-btn" style="color: blue;">Edit my Feedback</small>
                </div>
                <?php
                ...
                ?>
                  <div class="border-bottom p-3" style="margin-left: 5%;">
                    ...
                    <small>on: <?php echo date("M d,Y h:i", strtotime($reply['r_date'])) ?></small>
                  </div>
                <?php } ?>
              </div>
              ...
              <form action="processors/add_feedback.php?edit-feedback=true" method="POST" class="reply-form">
                <div class="form-group">
                  <textarea name="feedback" class="form-control to-be-filled" placeholder="Your Reply" required="required" rows="5" value=""></textarea>
                </div>
          ...
          ?>
            <form action="processors/add_feedback.php?add-feedback=true" method="POST">
              <div class="form-group">
                ...
                <div class="mb-3"> </div>
                <textarea name="feedback" type="text" class="form-control" placeholder="Your Feedback" required="required" rows="5" value=""></textarea>
              </div>
              <div class="justify-content-end d-flex">
