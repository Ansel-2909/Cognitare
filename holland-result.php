...
<div class="container">
  ...
  <?php 
  session_start();
  if(isset($_SESSION['u_test_attempt']) && $_SESSION['u_test_attempt'] == 1){
    ?>
  ...
  $sql = "SELECT * FROM scores WHERE s_user_id ='".$_SESSION['user_id']."'";
...
<div class="col-12 rounded bg-light border">
  <div class="header">RIASEC Test Result for <b><?php echo getUserFullname($_SESSION['user_id'])?></b>
  </div>
  <div class="box-content row">
    <div class="col">
...
<div class="col-12 rounded bg-light border">
  <div class="header"><b><?php echo getUserFullname($_SESSION['user_id'])?></b> You are Most Likely to take up...
    ...
    <?php 
      require 'connection.php';
      $sql = "SELECT * FROM feedbacks WHERE f_user_id ='".$_SESSION['user_id']."'";
        ...
        <?php while($row = $result->fetch_assoc()) {?>
         ...
         <div class="container">
          <div class="border-bottom p-3">
            ...
            <small>by: <?php echo getUserFullname($row['f_user_id'])?></small>
          ...
          foreach($replies as $reply){
            ...
            <div class="border-bottom p-3" style="margin-left: 5%">
              ...
              <small>by: <?php echo getUserFullname($reply['r_user_id'])?></small>
